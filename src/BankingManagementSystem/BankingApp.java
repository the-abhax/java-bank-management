                                ...
                                switch (choice2) {
                                    case 1 -> {
                                        try {
                                            ...
                                            System.out.println("Database error occurred during debit operation.");
                                            e.printStackTrace();
                                        }
                                    }
                                    case 2 -> {
                                        try {
                                            ...
                                            System.out.println("Database error occurred during credit operation.");
                                            e.printStackTrace();
                                        }
                                    }
                                    case 3 -> {
                                        try {
                                            ...
                                            System.out.println("Database error occurred during transfer operation.");
                                            e.printStackTrace();
                                        }
                                    }
